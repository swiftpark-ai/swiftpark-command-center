...
export function buildHelpGuideMessages(channels: ChannelDefinition[] = requiredChannelDefinitions): string[] {
  ...
  const second = [
    ...
    '4. Discuss revisions in the goal thread. If thread replies are enabled, questions get answered and clear change requests revise the plan.',
    ...
    '7. Click **Approve + Run**, or use `/approve` for execute-after-approval goals.',
    '8. Use **Plan Only** if you want approval without starting agents.',
    '9. Use Run Iris / Run Atlas / Run Sentinel buttons for manual overrides.',
