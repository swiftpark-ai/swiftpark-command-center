...
export function buildHelpGuideMessages(channels: ChannelDefinition[] = requiredChannelDefinitions): string[] {
  ...
  const second = [
    ...
    '4. Click **Ask Orion** for a quick read-only question/brainstorm reply in the goal thread.',
    '5. Discuss revisions in the goal thread. If thread replies are enabled, questions get answered and clear change requests revise the plan.',
