...
assert(botSource.includes('goal:revise-plan'), 'Revise Plan button missing');
assert(botSource.includes('goal-modal:ask-orion'), 'Ask Orion modal missing');
assert(botSource.includes('goal-modal:revise-plan'), 'Revise Plan modal missing');
assert(botSource.includes('TextInputStyle.Paragraph'), 'Ask Orion modal text input missing');
assert(botSource.includes('thread-history.jsonl'), 'goal thread history capture missing');
assert(botSource.includes('reconcileStartupState'), 'startup status reconciliation missing');
assert(botSource.includes('Saved plan unchanged'), 'revision-like thread chat should not silently mutate plan state');
